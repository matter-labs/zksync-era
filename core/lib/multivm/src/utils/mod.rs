...
pub fn derive_base_fee_and_gas_per_pubdata(
    ...
    match vm_version {
        ...
        | VmVersion::VmInterop | VmVersion::VmFullInterop => {
...
pub fn get_batch_base_fee(l1_batch_env: &L1BatchEnv, vm_version: VmVersion) -> u64 {
    match vm_version {
        ...
        | VmVersion::VmEvmEmulator
        | VmVersion::VmEcPrecompiles
        | VmVersion::VmInterop | VmVersion::VmFullInterop => crate::vm_latest::utils::fee::get_batch_base_fee(l1_batch_env),
    }
}
...
pub fn derive_overhead(
    ...
    match vm_version {
        ...
        | VmVersion::VmEvmEmulator
        | VmVersion::VmEcPrecompiles
        | VmVersion::VmInterop | VmVersion::VmFullInterop => crate::vm_latest::utils::overhead::derive_overhead(encoded_len),
    }
}
...
pub fn get_bootloader_encoding_space(version: VmVersion) -> u32 {
    match version {
        ...
        VmVersion::VmEcPrecompiles | VmVersion::VmInterop | VmVersion::VmFullInterop => {
            crate::vm_latest::constants::get_bootloader_tx_encoding_space(
...
pub fn get_bootloader_max_txs_in_batch(version: VmVersion) -> usize {
    match version {
        ...
        | VmVersion::VmEvmEmulator
        | VmVersion::VmEcPrecompiles
        | VmVersion::VmInterop | VmVersion::VmFullInterop => crate::vm_latest::constants::MAX_TXS_IN_BATCH,
    }
}
...
pub fn gas_bootloader_batch_tip_overhead(version: VmVersion) -> u32 {
    match version {
        ...
        | VmVersion::VmEvmEmulator
        | VmVersion::VmEcPrecompiles
        | VmVersion::VmInterop | VmVersion::VmFullInterop => crate::vm_latest::constants::BOOTLOADER_BATCH_TIP_OVERHEAD,
    }
}
...
pub fn get_max_gas_per_pubdata_byte(version: VmVersion) -> u64 {
    match version {
        ...
        | VmVersion::VmEvmEmulator
        | VmVersion::VmEcPrecompiles
        | VmVersion::VmInterop | VmVersion::VmFullInterop => crate::vm_latest::constants::MAX_GAS_PER_PUBDATA_BYTE,
    }
}
...
pub fn get_max_batch_gas_limit(version: VmVersion) -> u64 {
    match version {
        ...
        | VmVersion::VmEvmEmulator
        | VmVersion::VmEcPrecompiles
        | VmVersion::VmInterop | VmVersion::VmFullInterop => crate::vm_latest::constants::BATCH_GAS_LIMIT,
    }
}
...
pub fn get_eth_call_gas_limit(version: VmVersion) -> u64 {
    match version {
        ...
        | VmVersion::VmEvmEmulator
        | VmVersion::VmEcPrecompiles
        | VmVersion::VmInterop | VmVersion::VmFullInterop => crate::vm_latest::constants::ETH_CALL_GAS_LIMIT,
    }
}
...
pub fn get_max_batch_base_layer_circuits(version: VmVersion) -> usize {
    match version {
        ...
        | VmVersion::VmEvmEmulator
        | VmVersion::VmEcPrecompiles
        | VmVersion::VmInterop | VmVersion::VmFullInterop => crate::vm_latest::constants::MAX_BASE_LAYER_CIRCUITS,
    }
}
