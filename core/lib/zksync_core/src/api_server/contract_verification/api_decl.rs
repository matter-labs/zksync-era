...
use zksync_server_dal::connection::ServerConnectionPool;

#[derive(Debug, Clone)]
pub struct RestApi {
    pub(super) master_connection_pool: ServerConnectionPool,
    pub(super) replica_connection_pool: ServerConnectionPool,
}
