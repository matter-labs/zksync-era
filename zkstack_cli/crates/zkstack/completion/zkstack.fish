...
complete -c zkstack -n "__fish_zkstack_using_subcommand ecosystem; and __fish_seen_subcommand_from create" -l l1-network -d 'L1 Network' -r -f -a "{localhost\t'',sepolia\t'',holesky\t'',mainnet\t''}"
complete -c zkstack -n "__fish_zkstack_using_subcommand ecosystem; and __fish_seen_subcommand_from create" -l l1-wallets-path -d 'Wallets path' -r
...
complete -c zkstack -n "__fish_zkstack_using_subcommand chain; and __fish_seen_subcommand_from create" -l l1-wallets-path -d 'Wallets path' -r
...
complete -c zkstack -n "__fish_zkstack_using_subcommand help; and not __fish_seen_subcommand_from autocomplete ecosystem chain dev prover external-node containers portal explorer update markdown help" -f -a "autocomplete" -d 'Create shell autocompletion files'
complete -c zkstack -n "__fish_zkstack_using_subcommand help; and not __fish_seen_subcommand_from autocomplete ecosystem chain dev prover external-node containers portal explorer update markdown help" -f -a "ecosystem" -d 'Ecosystem related commands'
complete -c zkstack -n "__fish_zkstack_using_subcommand help; and not __fish_seen_subcommand_from autocomplete ecosystem chain dev prover external-node containers portal explorer update markdown help" -f -a "chain" -d 'Chain related commands'
complete -c zkstack -n "__fish_zkstack_using_subcommand help; and not __fish_seen_subcommand_from autocomplete ecosystem chain dev prover external-node containers portal explorer update markdown help" -f -a "dev" -d 'Supervisor related commands'
complete -c zkstack -n "__fish_zkstack_using_subcommand help; and not __fish_seen_subcommand_from autocomplete ecosystem chain dev prover external-node containers portal explorer update markdown help" -f -a "prover" -d 'Prover related commands'
complete -c zkstack -n "__fish_zkstack_using_subcommand help; and not __fish_seen_subcommand_from autocomplete ecosystem chain dev prover external-node containers portal explorer update markdown help" -f -a "external-node" -d 'External Node related commands'
complete -c zkstack -n "__fish_zkstack_using_subcommand help; and not __fish_seen_subcommand_from autocomplete ecosystem chain dev prover external-node containers portal explorer update markdown help" -f -a "containers" -d 'Run containers for local development'
complete -c zkstack -n "__fish_zkstack_using_subcommand help; and not __fish_seen_subcommand_from autocomplete ecosystem chain dev prover external-node containers portal explorer update markdown help" -f -a "portal" -d 'Run dapp-portal'
complete -c zkstack -n "__fish_zkstack_using_subcommand help; and not __fish_seen_subcommand_from autocomplete ecosystem chain dev prover external-node containers portal explorer update markdown help" -f -a "explorer" -d 'Run block-explorer'
...
complete -c zkstack -n "__fish_zkstack_using_subcommand help; and not __fish_seen_subcommand_from autocomplete ecosystem chain dev prover external-node containers portal explorer update markdown help" -f -a "markdown" -d 'Print markdown help'
complete -c zkstack -n "__fish_zkstack_using_subcommand help; and not __fish_seen_subcommand_from autocomplete ecosystem chain dev prover external-node containers portal explorer update markdown help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
