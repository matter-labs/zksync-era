...
export async function setup() {
    process.chdir('core/lib/dal');
    const localDbUrl = 'postgres://postgres@localhost/zksync_local';
    const localTestDbUrl = 'postgres://postgres@localhost/zksync_local_test';
    if (process.env.DATABASE_URL == localDbUrl || process.env.DATABASE_URL == localTestDbUrl) {
