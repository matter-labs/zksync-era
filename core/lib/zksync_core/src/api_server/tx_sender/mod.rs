...
use zksync_dal::{
    transactions_dal::L2TxSubmissionResult, BasicStorageProcessor, ConnectionPool, Server,
};
...
impl TxSender {
    ...
    async fn acquire_replica_connection(&self) -> anyhow::Result<BasicStorageProcessor<'_>> {
        self.0
            .replica_connection_pool
