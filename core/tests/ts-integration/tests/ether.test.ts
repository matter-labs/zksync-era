...
describe('ETH token checks', () => {
    ...
    test('Can perform a withdrawal', async () => {
        ...
        const hash = '0xa2a6e23d93eaffb1043a956d1332f70467db1b70d3e8463a850aac5b3a038151';

        // TODO (SMA-1374): Enable L1 ETH checks as soon as they're supported.
        await expect(alice.finalizeWithdrawal(hash)).toBeAccepted();
        const tx = await alice.provider.getTransactionReceipt(hash);
