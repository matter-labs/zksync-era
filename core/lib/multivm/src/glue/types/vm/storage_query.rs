...
impl GlueFrom<crate::vm_1_4_2::utils::logs::StorageLogQuery> for StorageLogQuery {
    fn glue_from(value: crate::vm_1_4_2::utils::logs::StorageLogQuery) -> Self {
        Self {
            log_query: value.log_query.glue_into(),
            log_type: value.log_type,
        }
...
impl GlueFrom<crate::vm_1_5_0::utils::logs::StorageLogQuery> for StorageLogQuery {
    fn glue_from(value: crate::vm_1_5_0::utils::logs::StorageLogQuery) -> Self {
        Self {
            log_query: value.log_query.glue_into(),
            log_type: value.log_type,
        }
