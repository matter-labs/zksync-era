...
use crate::{interface::L1BatchEnv, vm_virtual_blocks::utils::fee::get_batch_base_fee};
...
pub(crate) fn bootloader_initial_memory(l1_batch_env: &L1BatchEnv) -> Vec<(usize, U256)> {
    ...
    vec![
        ...
        (L1_GAS_PRICE_SLOT, l1_batch_env.fee_input.l1_gas_price()),
        (
            FAIR_L2_GAS_PRICE_SLOT,
            l1_batch_env.fee_input.fair_l2_gas_price(),
        ),
        (EXPECTED_BASE_FEE_SLOT, get_batch_base_fee(l1_batch_env)),
