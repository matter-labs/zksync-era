...
const BWG_QUEUED_STDOUT: &str = "== Batch 0 Status ==
...
const BWG_IN_PROGRESS_PROVER_UP_STDOUT: &str = "== Batch 0 Status ==

= Proving Stages =
-- Aggregation Round 0 --
Basic Witness Generator: In Progress ⌛️
> Prover Jobs: Queued 📥
...
const AGG_ROUND_0_COMPLETED_LWG_DOWN: &str = "== Batch 0 Status ==
...
const LWG_QUEUED_STDOUT: &str = "== Batch 0 Status ==
