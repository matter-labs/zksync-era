...
use zksync_dal::{transactions_dal::L2TxSubmissionResult, ConnectionPool, StorageProcessorWrapper};
...
impl TxSender {
    ...
    async fn acquire_replica_connection(&self) -> anyhow::Result<StorageProcessorWrapper<'_>> {
        self.0
            .replica_connection_pool
