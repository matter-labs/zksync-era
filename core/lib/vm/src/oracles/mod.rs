...
pub use zk_evm::reference_impls::memory::SimpleMemory as RamOracle;
// All the changes to the events in the DB will be applied after the tx is executed,
// so fow now it is fine.
pub use zk_evm::reference_impls::event_sink::InMemoryEventSink as EventSinkOracle;

pub use zk_evm::testing::simple_tracer::NoopTracer;
