...
use crate::{
    era_vm::tests::{
        ...
        utils::{read_test_contract, sort_execution_state},
    },
...
fn test_vm_rollbacks() {
    ...
    let mut result_without_rollbacks = vm.execute_and_verify_txs(&vec![
    ...
    let mut result_with_rollbacks = vm.execute_and_verify_txs(&vec![
    ...
    sort_execution_state(&mut result_with_rollbacks);
    sort_execution_state(&mut result_without_rollbacks);
