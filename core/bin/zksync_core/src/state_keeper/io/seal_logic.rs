...
pub(crate) fn seal_l1_batch_impl(
    ...
    track_l1_batch_execution_stage("vm_finalization", &mut stage_started_at);
    ...
    track_l1_batch_execution_stage("fictive_miniblock", &mut stage_started_at);
    ...
    track_l1_batch_execution_stage("log_deduplication", &mut stage_started_at);
    ...
    let l1_batch = L1BatchHeader {
        ...
        fee_account_address: fee_account,
    ...
    track_l1_batch_execution_stage("insert_l1_batch_header", &mut stage_started_at);

    transaction
        .blocks_dal()
        .mark_miniblocks_as_executed_in_l1_batch(current_l1_batch_number);
    track_l1_batch_execution_stage("set_l1_batch_number_for_miniblocks", &mut stage_started_at);
    ...
    track_l1_batch_execution_stage("mark_txs_as_executed_in_l1_batch", &mut stage_started_at);

    transaction
        .storage_logs_dedup_dal()
        .insert_storage_logs(current_l1_batch_number, &deduped_log_queries);
    track_l1_batch_execution_stage("insert_storage_dedup_logs", &mut stage_started_at);
    ...
    track_l1_batch_execution_stage("insert_protective_reads", &mut stage_started_at);

    transaction
        .storage_logs_dedup_dal()
        .insert_initial_writes(current_l1_batch_number, &deduplicated_writes);
    track_l1_batch_execution_stage("insert_initial_writes", &mut stage_started_at);

    transaction.commit_blocking();
    track_l1_batch_execution_stage("commit_l1_batch", &mut stage_started_at);
...
pub(crate) fn seal_miniblock_impl(
    ...
    track_miniblock_execution_stage("insert_miniblock_header", &mut stage_started_at);
    ...
    track_miniblock_execution_stage("mark_transactions_in_miniblock", &mut stage_started_at);
    ...
    track_miniblock_execution_stage("insert_storage_logs", &mut stage_started_at);

    let unique_updates = transaction.storage_dal().apply_storage_logs(&write_logs);
    track_miniblock_execution_stage("apply_storage_logs", &mut stage_started_at);
    ...
    track_miniblock_execution_stage("insert_factory_deps", &mut stage_started_at);
    ...
    track_miniblock_execution_stage("insert_tokens", &mut stage_started_at);
    ...
    track_miniblock_execution_stage("insert_events", &mut stage_started_at);
    ...
    track_miniblock_execution_stage("insert_l2_to_l1_logs", &mut stage_started_at);

    transaction.commit_blocking();
    track_miniblock_execution_stage("commit_miniblock", &mut stage_started_at);
