...
//     utils::{create_test_block_params, BASE_SYSTEM_CONTRACTS, BLOCK_GAS_LIMIT},
//     vm::tx_has_failed,
//     vm_with_bootloader::{init_vm_inner, push_transaction_to_bootloader_memory},
...
//         None,
//     );
//     let result = vm.execute_next_tx(u32::MAX, false).unwrap();
//     assert_eq!(
//         result.status,
