        ...
        Ok(Self {
            ...
            deployed_addresses: DeployedAddresses {
                ...
                bridges: Bridges {
                    ...
                    l1_nullifier_proxy_addr: contracts.bridges.l1_nullifier_addr.expect("l1_nullifier_addr"),
                },
                validator_timelock_addr: contracts.ecosystem_contracts.validator_timelock_addr,
                native_token_vault_addr: contracts.ecosystem_contracts.native_token_vault_addr.expect("native_token_vault_addr"),
            },
            chain: ChainL1Config {
