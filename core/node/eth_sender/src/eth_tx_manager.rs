...
use zksync_eth_client::{
    encode_blob_tx_with_sidecar, BoundEthInterface, ExecutedTxStatus, L1EthBoundInterface,
    RawTransactionBytes,
};
...
impl EthTxManager {
    pub fn new(
        ...
        ethereum_gateway: Box<L1EthBoundInterface>,
        ethereum_gateway_blobs: Option<Box<L1EthBoundInterface>>,
    ) -> Self {
