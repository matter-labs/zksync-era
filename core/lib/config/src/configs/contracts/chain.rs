...
pub struct L1ContractsConfig {
    ...
    pub gateway_base_token_addr: Option<Address>,
...
impl L1ContractsConfig {
    fn for_tests() -> Self {
        Self {
            ...
            gateway_base_token_addr: Some(Address::repeat_byte(0x19)),
...
impl ContractsConfig {
    ...
    pub fn l1_specific_contracts(&self) -> L1SpecificContracts {
        L1SpecificContracts {
            ...
            gateway_base_token_address: self.l1.gateway_base_token_addr,
...
mod tests {
    ...
    fn expected_config() -> ContractsConfig {
        ContractsConfig {
            l1: L1ContractsConfig {
                ...
                gateway_base_token_addr: Some(addr("0x0000000000000000000000000000000000000002")),
    ...
    fn parsing_from_env() {
        let env = r#"
            ...
            CONTRACTS_GATEWAY_BASE_TOKEN_ADDR="0x0000000000000000000000000000000000000002"
        ...
        let yaml = r#"
          contracts:
            ...
            l1:
              ...
              gateway_base_token_addr: '0x0000000000000000000000000000000000000002'
