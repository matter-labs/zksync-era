    ...
    pub(crate) fn collect_metrics(
        ...
        for &cf_name in &self.cf_names {
            ...
            if let Some(size) = index_and_filters_size {
                metrics.index_and_filters_size.set(size);
            }
