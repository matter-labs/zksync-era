...
pub(super) const MSG_UPGRADE_TEST_ABOUT: &str = "Run recovery tests";
...
pub(super) const MSG_UPGRADE_TEST_INSTALLING_DEPENDENCIES: &str =
    "Building and installing dependencies. This process may take a lot of time...";
pub(super) const MSG_UPGRADE_TEST_RUN_SUCCESS: &str = "Revert and restart test ran successfully";
