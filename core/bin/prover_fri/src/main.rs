...
use zksync_vk_setup_data_server_fri::{get_setup_data_for_circuit_type, ProverServiceDataKey};
...
use crate::prover_job_processor::{GoldilocksProverSetupData, Prover, SetupLoadMode};
