...
pub(crate) struct ProverFriMetrics {
    ...
    #[metrics(buckets = Buckets::LATENCIES, labels = ["circuit_type"])]
    pub gpu_proof_generation_time: LabeledFamily<&'static str, Histogram<Duration>>,
    #[metrics(buckets = Buckets::LATENCIES)]
    pub gpu_total_proving_time: Histogram<Duration>,
    #[metrics(buckets = Buckets::LATENCIES, labels = ["circuit_type"])]
    pub setup_data_load_time: LabeledFamily<&'static str, Histogram<Duration>>,
    #[metrics(buckets = Buckets::LATENCIES)]
    pub proof_generation_time: Family<CircuitLabels, Histogram<Duration>>,
    #[metrics(buckets = Buckets::LATENCIES, labels = ["circuit_type"])]
    pub proof_verification_time: LabeledFamily<&'static str, Histogram<Duration>>,
    #[metrics(buckets = Buckets::LATENCIES)]
    pub cpu_total_proving_time: Histogram<Duration>,
    #[metrics(buckets = Buckets::LATENCIES, labels = ["blob_size_in_gb"])]
    pub witness_vector_blob_time: LabeledFamily<&'static str, Histogram<Duration>>,
    #[metrics(buckets = Buckets::LATENCIES, labels = ["circuit_type"])]
    pub gpu_assembly_generation_time: LabeledFamily<&'static str, Histogram<Duration>>,
    #[metrics(buckets = Buckets::LATENCIES, labels = ["circuit_type"])]
    pub blob_save_time: LabeledFamily<&'static str, Histogram<Duration>>,
}
