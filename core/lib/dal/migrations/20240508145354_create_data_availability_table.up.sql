...
(
    ...
    -- the actual format if blob identifier and inclusion data is defined by the DA client implementation
    blob_id         BYTEA, -- blob here is an abstract term, unrelated to any DA implementation
