...
impl GlueFrom<crate::vm_m5::TxRevertReason> for crate::vm_latest::TxRevertReason {
    fn glue_from(value: crate::vm_m5::TxRevertReason) -> Self {
        match value {
            ...
            crate::vm_m5::TxRevertReason::ValidationFailed(err) => {
                Self::Halt(crate::vm_latest::Halt::ValidationFailed(err.glue_into()))
            }
            crate::vm_m5::TxRevertReason::PaymasterValidationFailed(err) => Self::Halt(
                crate::vm_latest::Halt::PaymasterValidationFailed(err.glue_into()),
            ),
            crate::vm_m5::TxRevertReason::PrePaymasterPreparationFailed(err) => Self::Halt(
                crate::vm_latest::Halt::PrePaymasterPreparationFailed(err.glue_into()),
            ),
            crate::vm_m5::TxRevertReason::PayForTxFailed(err) => {
                Self::Halt(crate::vm_latest::Halt::PayForTxFailed(err.glue_into()))
            }
            crate::vm_m5::TxRevertReason::FailedToMarkFactoryDependencies(err) => Self::Halt(
                crate::vm_latest::Halt::FailedToMarkFactoryDependencies(err.glue_into()),
            ),
            crate::vm_m5::TxRevertReason::FailedToChargeFee(err) => {
                Self::Halt(crate::vm_latest::Halt::FailedToChargeFee(err.glue_into()))
            }
            crate::vm_m5::TxRevertReason::FromIsNotAnAccount => {
                Self::Halt(crate::vm_latest::Halt::FromIsNotAnAccount)
            }
            crate::vm_m5::TxRevertReason::InnerTxError => {
                Self::Halt(crate::vm_latest::Halt::InnerTxError)
            }
            crate::vm_m5::TxRevertReason::Unknown(err) => {
                Self::Halt(crate::vm_latest::Halt::Unknown(err.glue_into()))
            }
            crate::vm_m5::TxRevertReason::UnexpectedVMBehavior(err) => {
                Self::Halt(crate::vm_latest::Halt::UnexpectedVMBehavior(err))
            }
            crate::vm_m5::TxRevertReason::BootloaderOutOfGas => {
                Self::Halt(crate::vm_latest::Halt::BootloaderOutOfGas)
            }
            crate::vm_m5::TxRevertReason::TooBigGasLimit => {
                Self::Halt(crate::vm_latest::Halt::TooBigGasLimit)
            }
            crate::vm_m5::TxRevertReason::NotEnoughGasProvided => {
                Self::Halt(crate::vm_latest::Halt::NotEnoughGasProvided)
            }
        }
    }
}

impl GlueFrom<crate::vm_m6::TxRevertReason> for crate::vm_latest::TxRevertReason {
    fn glue_from(value: crate::vm_m6::TxRevertReason) -> Self {
        match value {
            ...
            crate::vm_m6::TxRevertReason::MissingInvocationLimitReached => {
                Self::Halt(crate::vm_latest::Halt::MissingInvocationLimitReached)
            }
        }
    }
}

impl GlueFrom<crate::vm_1_3_2::TxRevertReason> for crate::vm_latest::TxRevertReason {
