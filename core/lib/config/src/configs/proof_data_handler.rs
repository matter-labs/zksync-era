...
pub struct ProofDataHandlerConfig {
    ...
    #[config(default)]
    pub prover_handling_mode: ProverHandlingMode,
}

#[derive(Debug, Default, Clone, PartialEq, Serialize, Deserialize)]
pub enum ProverHandlingMode {
    #[default]
    ProverCluster,
    ProvingNetwork,
}

impl WellKnown for ProverHandlingMode {
...
mod tests {
    ...
    fn expected_config() -> ProofDataHandlerConfig {
        ProofDataHandlerConfig {
            ...
            prover_handling_mode: ProverHandlingMode::ProvingNetwork,
        }
    }
    ...
    fn parsing_from_env() {
        let env = r#"
            ...
            PROOF_DATA_HANDLER_PROVER_HANDLING_MODE=PROVING_NETWORK
        "#;
    ...
    fn parsing_from_yaml() {
        let yaml = r#"
          ...
          fetch_zero_chain_id_proofs: false
          prover_handling_mode: PROVING_NETWORK
        "#;
