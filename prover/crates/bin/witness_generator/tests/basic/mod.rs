...
use zksync_types::prover_dal::LeafAggregationJobMetadata;
use zksync_types::L1BatchNumber;
use zksync_witness_generator::rounds::{JobManager, LeafAggregation};
...
async fn test() {
    ...
    let object_store_config = ObjectStoreConfig {
        mode: ObjectStoreMode::FileBacked {
            file_backed_base_path: "./data/".to_owned(),
        },
        max_retries: 5,
