...
use crate::{forge_interface::deploy_ecosystem::input::InitialDeploymentConfig, traits::{FileConfigWithDefaultName, ZkToolboxConfig}, ChainConfig, ContractsConfig, EcosystemConfig};
...
// impl FileConfigWithDefaultName for DeployGatewayCTMInput {
...
impl DeployGatewayCTMInput {
    pub fn new(
        ...
        Self {
            ...
            stm_deployment_tracker_proxy_addr: contracts_config.ecosystem_contracts.stm_deployment_tracker_proxy_addr,
            native_token_vault_addr: contracts_config.ecosystem_contracts.native_token_vault_addr,
            state_transition_proxy_addr: contracts_config.ecosystem_contracts.state_transition_proxy_addr,
            ...
            diamond_init_pubdata_pricing_mode: initial_deployment_config.diamond_init_pubdata_pricing_mode,
            diamond_init_batch_overhead_l1_gas: initial_deployment_config.diamond_init_batch_overhead_l1_gas,
            diamond_init_max_pubdata_per_batch: initial_deployment_config.diamond_init_max_pubdata_per_batch,
            diamond_init_max_l2_gas_per_batch: initial_deployment_config.diamond_init_max_l2_gas_per_batch,
            diamond_init_priority_tx_max_pubdata: initial_deployment_config.diamond_init_priority_tx_max_pubdata,
            diamond_init_minimal_l2_gas_price: initial_deployment_config.diamond_init_minimal_l2_gas_price,
            ...
            force_deployments_data: contracts_config.ecosystem_contracts.force_deployments_data.clone(),        
        }
    }
}
