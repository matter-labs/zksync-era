...
impl AccountProperties {
    pub fn encode(&self) -> [u8; 124] {
        ...
        result.extend_from_slice(&self.versioning_data.to_le_bytes());
        ...
        result.extend_from_slice(&self.bytecode_len.to_le_bytes());
        result.extend_from_slice(&self.artifacts_len.to_le_bytes());
        result.extend_from_slice(&self.observable_bytecode_len.to_le_bytes());
