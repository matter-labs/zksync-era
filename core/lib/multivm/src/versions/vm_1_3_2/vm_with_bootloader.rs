...
use zksync_types::{
    ...
    l1::is_l1_tx_type, Address, Transaction, BOOTLOADER_ADDRESS, L1_GAS_PER_PUBDATA_BYTE, U256,
};
...
pub fn init_vm<S: WriteStorage, H: HistoryMode>(
    oracle_tools: OracleTools<S, false, H>,
...
pub fn init_vm_with_gas_limit<S: WriteStorage, H: HistoryMode>(
    oracle_tools: OracleTools<S, false, H>,
    block_context: BlockContextMode,
    block_properties: BlockProperties,
    execution_mode: TxExecutionMode,
...
pub fn init_vm_inner<S: WriteStorage, H: HistoryMode>(
    mut oracle_tools: OracleTools<S, false, H>,
    block_context: BlockContextMode,
    block_properties: BlockProperties,
    gas_limit: u32,
    base_system_contract: &BaseSystemContracts,
...
pub fn push_transaction_to_bootloader_memory<H: HistoryMode, S: WriteStorage>(
...
fn get_default_local_state<S: WriteStorage, H: HistoryMode>(
    tools: OracleTools<S, false, H>,
    block_properties: BlockProperties,
    gas_limit: u32,
) -> ZkSyncVmState<S, H> {
