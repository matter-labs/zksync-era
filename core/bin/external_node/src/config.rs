...
pub struct OptionalENConfig {
    ...
    #[serde(alias = "max_blocks_per_tree_batch")]
    max_l1_batches_per_tree_iter: Option<usize>,
...
impl OptionalENConfig {
    ...
    pub fn max_l1_batches_per_tree_iter(&self) -> usize {
        self.max_l1_batches_per_tree_iter.unwrap_or(20)
    }
    ...
    pub fn experimental_multivm_support(&self) -> bool {
        self.experimental_multivm_support
    }
    ...
    pub fn max_response_body_size(&self) -> usize {
        self.max_response_body_size_mb.unwrap_or(10) * BYTES_IN_MEGABYTE
    }
}
...
pub struct RequiredENConfig {
    ...
    // TODO (BFT-237) The following fields are required for the EN operation, but shouldn't be.
