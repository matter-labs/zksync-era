...
import type { IBridgeheadChain } from "./IBridgeheadChain";

export class IBridgeheadChainFactory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IBridgeheadChain {
    return new Contract(address, _abi, signerOrProvider) as IBridgeheadChain;
  }
}
...
const _abi = [
  ...
  },
  {
    ...
    name: "collectOperationsFromPriorityQueue",
    outputs: [
      {
        internalType: "bytes32",
        name: "",
