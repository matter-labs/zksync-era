...
mod snapshots_applier_tests {
    ...
    async fn snapshots_creator_can_successfully_recover_db() {
        ...
        let snapshot_miniblock_hash = H256::random();
        ...
        let snapshot_header = SnapshotHeader {
            l1_batch_number,
            miniblock_number,
            last_l1_batch_with_metadata: l1_block_metadata(l1_batch_number, root_hash),
        ...
        client.fetch_l2_block_responses.insert(
            miniblock_number,
            miniblock_metadata(miniblock_number, l1_batch_number, snapshot_miniblock_hash),
        );
        ...
        let expected_status = SnapshotRecoveryStatus {
            ...
            l1_batch_root_hash: root_hash,
            miniblock_number,
            miniblock_timestamp: 0,
            miniblock_hash: snapshot_miniblock_hash,
