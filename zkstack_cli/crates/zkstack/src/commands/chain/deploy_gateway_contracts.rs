...
//     #[clap(long)]
//     pub local_upgrade: Option<bool>
// }

// // Deploys Gateway CTM as well as the transaction filterer for the current chain.
// // Returns the output
...
//     let local_upgrade = args.local_upgrade.unwrap_or_default();
