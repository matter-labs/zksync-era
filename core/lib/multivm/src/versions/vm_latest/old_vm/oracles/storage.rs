...
fn get_pubdata_price_bytes(_query: &LogQuery, is_initial: bool) -> u32 {
    ...
    // should cost less.
    if is_initial {
        zk_evm_1_4_1::zkevm_opcode_defs::system_params::INITIAL_STORAGE_WRITE_PUBDATA_BYTES as u32
    } else {
        zk_evm_1_4_1::zkevm_opcode_defs::system_params::REPEATED_STORAGE_WRITE_PUBDATA_BYTES as u32
    }
}
