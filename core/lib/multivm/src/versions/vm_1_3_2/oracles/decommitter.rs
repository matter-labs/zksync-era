...
impl<S: WriteStorage, const B: bool, H: HistoryMode> DecommitterOracle<S, B, H> {
...
impl<S: WriteStorage, const B: bool> OracleWithHistory for DecommitterOracle<S, B, HistoryEnabled> {
...
impl<S: WriteStorage, const B: bool, H: HistoryMode> DecommittmentProcessor
    for DecommitterOracle<S, B, H>
{
