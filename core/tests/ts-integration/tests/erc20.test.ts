...
describe('L1 ERC20 contract checks', () => {
    ...
    test.skip('Can perform a withdrawal', async () => {
        ...
        log("withdrawalTx.hash", withdrawalTx.hash);

        const receipt = await alice.provider.getTransactionReceipt(withdrawalTx.hash);
        const log2 = receipt!.logs.filter(
            log =>
        ...
        // console.log('s2', coder.decode(['bytes'], ''));
        // log('s', coder.decode(['bytes'], log2.data));

        log('params', await alice.getFinalizeWithdrawalParams(withdrawalTx.hash));
        // return;

        // const tx = await alice.finalizeWithdrawal(withdrawalTx.hash);
        // log("tx", tx);
        // log("tx.wait", await tx.wait());
