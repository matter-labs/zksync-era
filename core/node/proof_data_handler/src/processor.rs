...
impl Processor {
    ...
    async fn lock_batch_for_proving(&self) -> Result<Option<L1BatchNumber>, ProcessorError> {
        self.pool
            .connection()
            .await
    ...
    pub async fn save_proof(
        &self,
        l1_batch_number: L1BatchNumber,
        proof: Option<L1BatchProofForL1>,
    ) -> Result<(), ProcessorError> {
        tracing::info!("Saving proof for block number: {:?}", l1_batch_number);
