...
complete -c zkstack -n "__fish_zkstack_using_subcommand ecosystem; and not __fish_seen_subcommand_from create build-transactions init change-default-chain setup-observability containers explorer help" -l chain -d 'Chain to use' -r
complete -c zkstack -n "__fish_zkstack_using_subcommand ecosystem; and not __fish_seen_subcommand_from create build-transactions init change-default-chain setup-observability containers explorer help" -s v -l verbose -d 'Verbose mode'
complete -c zkstack -n "__fish_zkstack_using_subcommand ecosystem; and not __fish_seen_subcommand_from create build-transactions init change-default-chain setup-observability containers explorer help" -l ignore-prerequisites -d 'Ignores prerequisites checks'
complete -c zkstack -n "__fish_zkstack_using_subcommand ecosystem; and not __fish_seen_subcommand_from create build-transactions init change-default-chain setup-observability containers explorer help" -s h -l help -d 'Print help'
complete -c zkstack -n "__fish_zkstack_using_subcommand ecosystem; and not __fish_seen_subcommand_from create build-transactions init change-default-chain setup-observability containers explorer help" -f -a "create" -d 'Create a new ecosystem and chain, setting necessary configurations for later initialization'
complete -c zkstack -n "__fish_zkstack_using_subcommand ecosystem; and not __fish_seen_subcommand_from create build-transactions init change-default-chain setup-observability containers explorer help" -f -a "build-transactions" -d 'Create transactions to build ecosystem contracts'
complete -c zkstack -n "__fish_zkstack_using_subcommand ecosystem; and not __fish_seen_subcommand_from create build-transactions init change-default-chain setup-observability containers explorer help" -f -a "init" -d 'Initialize ecosystem and chain, deploying necessary contracts and performing on-chain operations'
complete -c zkstack -n "__fish_zkstack_using_subcommand ecosystem; and not __fish_seen_subcommand_from create build-transactions init change-default-chain setup-observability containers explorer help" -f -a "change-default-chain" -d 'Change the default chain'
complete -c zkstack -n "__fish_zkstack_using_subcommand ecosystem; and not __fish_seen_subcommand_from create build-transactions init change-default-chain setup-observability containers explorer help" -f -a "setup-observability" -d 'Setup observability for the ecosystem, downloading Grafana dashboards from the era-observability repo'
complete -c zkstack -n "__fish_zkstack_using_subcommand ecosystem; and not __fish_seen_subcommand_from create build-transactions init change-default-chain setup-observability containers explorer help" -f -a "containers" -d 'Run containers for local development'
complete -c zkstack -n "__fish_zkstack_using_subcommand ecosystem; and not __fish_seen_subcommand_from create build-transactions init change-default-chain setup-observability containers explorer help" -f -a "explorer" -d 'Run block-explorer'
complete -c zkstack -n "__fish_zkstack_using_subcommand ecosystem; and not __fish_seen_subcommand_from create build-transactions init change-default-chain setup-observability containers explorer help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c zkstack -n "__fish_zkstack_using_subcommand help; and not __fish_seen_subcommand_from autocomplete ecosystem chain dev prover external-node portal update markdown help" -f -a "autocomplete" -d 'Create shell autocompletion files'
complete -c zkstack -n "__fish_zkstack_using_subcommand help; and not __fish_seen_subcommand_from autocomplete ecosystem chain dev prover external-node portal update markdown help" -f -a "ecosystem" -d 'Ecosystem related commands'
complete -c zkstack -n "__fish_zkstack_using_subcommand help; and not __fish_seen_subcommand_from autocomplete ecosystem chain dev prover external-node portal update markdown help" -f -a "chain" -d 'Chain related commands'
complete -c zkstack -n "__fish_zkstack_using_subcommand help; and not __fish_seen_subcommand_from autocomplete ecosystem chain dev prover external-node portal update markdown help" -f -a "dev" -d 'Supervisor related commands'
complete -c zkstack -n "__fish_zkstack_using_subcommand help; and not __fish_seen_subcommand_from autocomplete ecosystem chain dev prover external-node portal update markdown help" -f -a "prover" -d 'Prover related commands'
complete -c zkstack -n "__fish_zkstack_using_subcommand help; and not __fish_seen_subcommand_from autocomplete ecosystem chain dev prover external-node portal update markdown help" -f -a "external-node" -d 'External Node related commands'
complete -c zkstack -n "__fish_zkstack_using_subcommand help; and not __fish_seen_subcommand_from autocomplete ecosystem chain dev prover external-node portal update markdown help" -f -a "portal" -d 'Run dapp-portal'
complete -c zkstack -n "__fish_zkstack_using_subcommand help; and not __fish_seen_subcommand_from autocomplete ecosystem chain dev prover external-node portal update markdown help" -f -a "update" -d 'Update ZKsync'
complete -c zkstack -n "__fish_zkstack_using_subcommand help; and not __fish_seen_subcommand_from autocomplete ecosystem chain dev prover external-node portal update markdown help" -f -a "markdown" -d 'Print markdown help'
complete -c zkstack -n "__fish_zkstack_using_subcommand help; and not __fish_seen_subcommand_from autocomplete ecosystem chain dev prover external-node portal update markdown help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
