...
ALTER TABLE snapshot_recovery ADD COLUMN storage_logs_chunks_ids_to_process INT[] NOT NULL;
ALTER TABLE snapshot_recovery ADD COLUMN storage_logs_chunks_ids_already_processed INT[] NOT NULL;
