use circuit_sequencer_api_1_5_0::geometry_config::{GeometryConfig, ProtocolGeometry};
...
const GEOMETRY_CONFIG: GeometryConfig = ProtocolGeometry::config(ProtocolGeometry::V1_5_0);
