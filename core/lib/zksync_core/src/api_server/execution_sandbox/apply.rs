...
use multivm::{HistoryDisabled, VmInstance, VmInstanceData};
use std::time::{Duration, Instant};
use vm::{constants::BLOCK_GAS_LIMIT, L1BatchEnv, L2BlockEnv, SystemEnv};
...
pub(super) fn apply_vm_in_sandbox<T>(
    ...
    vm_metrics::report_vm_storage_metrics(
        &tx_id,
        vm_execution_took,
