...
impl NodeAggregationWitnessGenerator {
    ...
    pub fn process_job_sync(
        ...
        WITNESS_GENERATOR_METRICS.witness_generation_time
            [&crate::metrics::AggregationRound::NodeAggregation]
...
pub async fn prepare_job(
    ...
    WITNESS_GENERATOR_METRICS.blob_fetch_time[&crate::metrics::AggregationRound::NodeAggregation]
        .observe(started_at.elapsed());
    ...
    WITNESS_GENERATOR_METRICS.prepare_job_time[&crate::metrics::AggregationRound::NodeAggregation]
        .observe(started_at.elapsed());
...
async fn save_artifacts(
    ...
    WITNESS_GENERATOR_METRICS.blob_save_time[&crate::metrics::AggregationRound::NodeAggregation]
        .observe(started_at.elapsed());
