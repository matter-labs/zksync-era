_zkstack() {
    ...
    do
        case "${cmd},${i}" in
            ...
            zkstack__chain,enable-evm-emulator)
                ...
                ;;
            zkstack__chain,gateway-upgrade)
                cmd="zkstack__chain__gateway__upgrade"
                ;;
            ...
            zkstack__chain,migrate-to-gateway)
                ...
                ;;
            zkstack__chain,notify-about-from-gateway-update)
                cmd="zkstack__chain__notify__about__from__gateway__update"
                ;;
            zkstack__chain,notify-about-to-gateway-update)
                cmd="zkstack__chain__notify__about__to__gateway__update"
                ;;
            ...
            zkstack__chain__help,enable-evm-emulator)
                ...
                ;;
            zkstack__chain__help,gateway-upgrade)
                cmd="zkstack__chain__help__gateway__upgrade"
                ;;
            ...
            zkstack__chain__help,migrate-to-gateway)
                ...
                ;;
            zkstack__chain__help,notify-about-from-gateway-update)
                cmd="zkstack__chain__help__notify__about__from__gateway__update"
                ;;
            zkstack__chain__help,notify-about-to-gateway-update)
                cmd="zkstack__chain__help__notify__about__to__gateway__update"
                ;;
            ...
            zkstack__dev,fmt)
                ...
                ;;
            zkstack__dev,gateway-l2-token-registration)
                cmd="zkstack__dev__gateway__l2__token__registration"
                ;;
            zkstack__dev,gateway-upgrade-calldata)
                cmd="zkstack__dev__gateway__upgrade__calldata"
                ;;
            zkstack__dev,gateway-upgrade-finalization)
                cmd="zkstack__dev__gateway__upgrade__finalization"
                ;;
            ...
            zkstack__dev__help,fmt)
                ...
                ;;
            zkstack__dev__help,gateway-l2-token-registration)
                cmd="zkstack__dev__help__gateway__l2__token__registration"
                ;;
            zkstack__dev__help,gateway-upgrade-calldata)
                cmd="zkstack__dev__help__gateway__upgrade__calldata"
                ;;
            zkstack__dev__help,gateway-upgrade-finalization)
                cmd="zkstack__dev__help__gateway__upgrade__finalization"
                ;;
            ...
            zkstack__ecosystem,create)
                ...
                ;;
            zkstack__ecosystem,gateway-upgrade)
                cmd="zkstack__ecosystem__gateway__upgrade"
                ;;
            ...
            zkstack__ecosystem__help,create)
                ...
                ;;
            zkstack__ecosystem__help,gateway-upgrade)
                cmd="zkstack__ecosystem__help__gateway__upgrade"
                ;;
            ...
            zkstack__help__chain,enable-evm-emulator)
                ...
                ;;
            zkstack__help__chain,gateway-upgrade)
                cmd="zkstack__help__chain__gateway__upgrade"
                ;;
            ...
            zkstack__help__chain,migrate-to-gateway)
                ...
                ;;
            zkstack__help__chain,notify-about-from-gateway-update)
                cmd="zkstack__help__chain__notify__about__from__gateway__update"
                ;;
            zkstack__help__chain,notify-about-to-gateway-update)
                cmd="zkstack__help__chain__notify__about__to__gateway__update"
                ;;
            ...
            zkstack__help__dev,fmt)
                ...
                ;;
            zkstack__help__dev,gateway-l2-token-registration)
                cmd="zkstack__help__dev__gateway__l2__token__registration"
                ;;
            zkstack__help__dev,gateway-upgrade-calldata)
                cmd="zkstack__help__dev__gateway__upgrade__calldata"
                ;;
            zkstack__help__dev,gateway-upgrade-finalization)
                cmd="zkstack__help__dev__gateway__upgrade__finalization"
                ;;
            ...
            zkstack__help__ecosystem,create)
                ...
                ;;
            zkstack__help__ecosystem,gateway-upgrade)
                cmd="zkstack__help__ecosystem__gateway__upgrade"
                ;;
    ...
    case "${cmd}" in
        ...
        zkstack__chain__help__migrate__to__gateway)
            ...
            return 0
            ;;
        zkstack__chain__help__notify__about__from__gateway__update)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        zkstack__chain__help__notify__about__to__gateway__update)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        zkstack__chain__migrate__to__gateway)
            ...
            return 0
            ;;
        zkstack__chain__notify__about__from__gateway__update)
            opts="-a -v -h --verify --verifier --verifier-url --verifier-api-key --resume --zksync --additional-args --verbose --chain --ignore-prerequisites --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        zkstack__chain__notify__about__to__gateway__update)
            opts="-a -v -h --verify --verifier --verifier-url --verifier-api-key --resume --zksync --additional-args --verbose --chain --ignore-prerequisites --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        zkstack__contract__verifier__wait)
            ...
            ;;
        zkstack__dev)
            opts="-v -h --verbose --chain --ignore-prerequisites --help database test clean snapshot lint fmt prover contracts config-writer send-transactions status generate-genesis gateway-upgrade-calldata gateway-upgrade-finalization gateway-l2-token-registration help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        zkstack__dev__fmt__rustfmt)
            ...
            return 0
            ;;
        zkstack__dev__gateway__l2__token__registration)
            opts="-v -h --verbose --chain --ignore-prerequisites --help <CHAIN_ID> <L2_RPC_URL> <PRIVATE_KEY> [L2_TOKENS_INDEXING_BLOCK_RANGE]"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        zkstack__dev__gateway__upgrade__calldata)
            opts="-v -h --dangerous-no-cross-check --force-display-finalization-params --verbose --chain --ignore-prerequisites --help <UPGRADE_DESCRIPTION_PATH> <CHAIN_ID> <L1_RPC_URL> <L2_RPC_URL> <VALIDATOR_ADDR1> <VALIDATOR_ADDR2> <SERVER_UPGRADE_TIMESTAMP> validium temporary-rollup permanent-rollup [L2_TOKENS_INDEXING_BLOCK_RANGE]"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        zkstack__dev__gateway__upgrade__finalization)
            opts="-v -h --send-finalize --verbose --chain --ignore-prerequisites --help <UPGRADE_DESCRIPTION_PATH> <L1_RPC_URL> <BLOCK_TO_START_WITH> <ERA_CHAIN_ID> <MULTICALL_WITH_GAS_ADDR>"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        zkstack__dev__generate__genesis)
            ...
            ;;
        zkstack__dev__help)
            opts="database test clean snapshot lint fmt prover contracts config-writer send-transactions status generate-genesis gateway-upgrade-calldata gateway-upgrade-finalization gateway-l2-token-registration help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        zkstack__dev__help__fmt__rustfmt)
            ...
            return 0
            ;;
        zkstack__dev__help__gateway__l2__token__registration)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        zkstack__dev__help__gateway__upgrade__calldata)
            ...
            return 0
            ;;
        zkstack__dev__help__gateway__upgrade__finalization)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        zkstack__dev__test__wallet)
            ...
            ;;
        zkstack__ecosystem)
            opts="-v -h --verbose --chain --ignore-prerequisites --help create build-transactions init change-default-chain setup-observability gateway-upgrade help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        zkstack__ecosystem__create)
            ...
            return 0
            ;;
        zkstack__ecosystem__gateway__upgrade)
            opts="-a -v -h --verify --verifier --verifier-url --verifier-api-key --resume --zksync --additional-args --ecosystem-upgrade-stage --ecosystem-contracts-path --l1-rpc-url --verbose --chain --ignore-prerequisites --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            case "${prev}" in
                ...
                --ecosystem-upgrade-stage)
                    COMPREPLY=($(compgen -W "no-governance-prepare governance-stage1 governance-stage2 no-governance-stage2 governance-stage3 no-governance-stage3" -- "${cur}"))
                    return 0
                    ;;
        ...
        zkstack__ecosystem__help)
            opts="create build-transactions init change-default-chain setup-observability gateway-upgrade help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        zkstack__ecosystem__help__create)
            ...
            return 0
            ;;
        zkstack__ecosystem__help__gateway__upgrade)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        zkstack__help__chain)
            opts="create build-transactions init genesis register-chain deploy-l2-contracts accept-chain-ownership deploy-consensus-registry deploy-multicall3 deploy-timestamp-asserter deploy-upgrader deploy-paymaster update-token-multiplier-setter convert-to-gateway migrate-to-gateway migrate-from-gateway gateway-upgrade enable-evm-emulator notify-about-to-gateway-update notify-about-from-gateway-update"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        zkstack__help__chain__enable__evm__emulator)
            ...
            return 0
            ;;
        zkstack__help__chain__gateway__upgrade)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        zkstack__help__chain__migrate__to__gateway)
            ...
            return 0
            ;;
        zkstack__help__chain__notify__about__from__gateway__update)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        zkstack__help__chain__notify__about__to__gateway__update)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        zkstack__help__contract__verifier__wait)
            ...
            ;;
        zkstack__help__dev)
            opts="database test clean snapshot lint fmt prover contracts config-writer send-transactions status generate-genesis gateway-upgrade-calldata gateway-upgrade-finalization gateway-l2-token-registration"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        zkstack__help__dev__fmt__rustfmt)
            ...
            return 0
            ;;
        zkstack__help__dev__gateway__l2__token__registration)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        zkstack__help__dev__gateway__upgrade__calldata)
            ...
            return 0
            ;;
        zkstack__help__dev__gateway__upgrade__finalization)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        zkstack__help__ecosystem)
            opts="create build-transactions init change-default-chain setup-observability gateway-upgrade"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        zkstack__help__ecosystem__create)
            ...
            return 0
            ;;
        zkstack__help__ecosystem__gateway__upgrade)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
