...
mod tests {
    ...
    fn expected_config() -> HouseKeeperConfig {
        HouseKeeperConfig {
            ...
            fri_prover_job_archivation_reporting_interval_ms: 0,
            fri_prover_job_archivation_archiving_interval_ms: 0,
        }
    }
    ...
    fn from_env() {
        ...
        let config = r#"
            ...
            HOUSE_KEEPER_FRI_PROVER_JOB_ARCHIVATION_REPORTING_INTERVAL_MS="0"
            HOUSE_KEEPER_FRI_PROVER_JOB_ARCHIVATION_ARCHIVING_INTERVAL_MS="0"
        "#;
        lock.set_env(config);
