...
use zksync_airbender_prover_interface::{api::SubmitAirbenderProofRequest, outputs::L1BatchAirbenderProofForL1};
...
fn test_airbender_proof_request_serialization() {
    ...
    let airbender_proof_result = serde_json::from_str::<SubmitAirbenderProofRequest>(airbender_proof_str).unwrap();
    let airbender_proof_expected = SubmitAirbenderProofRequest(Box::new(L1BatchAirbenderProofForL1 {
