...
zkstack dev run-v29-ecosystem-upgrade --ecosystem-upgrade-stage no-governance-prepare

zkstack dev run-v29-ecosystem-upgrade --ecosystem-upgrade-stage governance-stage0

zkstack  dev run-v29-ecosystem-upgrade --ecosystem-upgrade-stage governance-stage1
...
zkstack  dev run-v29-ecosystem-upgrade --ecosystem-upgrade-stage governance-stage2
