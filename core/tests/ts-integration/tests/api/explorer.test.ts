...
describe('Tests for the Explorer API', () => {
    ...
    test('should test vyper contract verification', async () => {
        ...
        const contractFactory = new zksync.ContractFactory(contracts.greeter2.abi, contracts.greeter2.bytecode, alice);
        ...
        await expectVerifyRequestToSucceed(requestId, contract.address);
    });
