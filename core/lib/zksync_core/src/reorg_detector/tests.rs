...
async fn store_miniblock(storage: &mut StorageProcessorWrapper<'_>, number: u32, hash: H256) {
...
async fn seal_l1_batch(storage: &mut StorageProcessorWrapper<'_>, number: u32, hash: H256) {
