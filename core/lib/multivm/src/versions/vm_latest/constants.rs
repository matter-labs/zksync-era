...
pub(crate) const MAX_BATCH_TIP_PUBDATA_PUBLISHED: u64 = 0;
pub(crate) const MAX_BATCH_TIP_CIRCUIT_STATISTICS: u64 = 2000;
pub(crate) const MAX_BATCH_TIP_METRICS_SIZE: u64 = 1500;
