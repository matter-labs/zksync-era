/// Observability configuration for the External Node.
/// It is kept outside of the main configuration, since it's loaded and used
/// before the actual EN initialization starts.
#[derive(Debug, Clone)]
