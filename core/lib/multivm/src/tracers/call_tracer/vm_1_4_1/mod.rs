...
impl CallTracer {
    fn handle_far_call_op_code_vm_1_4_1<H: HistoryMode>(
        &mut self,
        state: VmLocalStateData<'_>,
        memory: &SimpleMemory<H>,
    ...
    fn save_output_vm_1_4_1<H: HistoryMode>(
        &mut self,
        state: VmLocalStateData<'_>,
        memory: &SimpleMemory<H>,
    ...
    fn handle_ret_op_code_vm_1_4_1<H: HistoryMode>(
        &mut self,
        state: VmLocalStateData<'_>,
        memory: &SimpleMemory<H>,
        ret_opcode: RetOpcode,
        ...
        self.save_output_vm_1_4_1(state, memory, ret_opcode, &mut current_call.farcall);
