...
use crate::{
    ...
    proof_manager_dal::ProofManagerDal, protocol_versions_dal::ProtocolVersionsDal,
    ...
    Self: 'a,
{
    ...
    fn proof_manager_dal(&mut self) -> ProofManagerDal<'_, 'a>;
}
