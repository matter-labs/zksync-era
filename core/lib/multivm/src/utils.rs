...
pub fn get_bootloader_encoding_space(version: VmVersion) -> u32 {
    match version {
        ...
        VmVersion::Vm1_5_0 => crate::vm_latest::constants::get_bootloader_tx_encoding_space(
            VmVersion::Vm1_5_0.try_into().unwrap(),
        ),
        VmVersion::Vm_1_5_0_IncreaedBootloaderMemory => {
...
pub fn get_used_bootloader_memory_bytes(version: VmVersion) -> usize {
    match version {
        ...
        VmVersion::Vm1_5_0 => crate::vm_latest::constants::get_used_bootloader_memory_bytes(
            VmVersion::Vm1_5_0.try_into().unwrap(),
        ),
        VmVersion::Vm_1_5_0_IncreaedBootloaderMemory => {
...
pub fn get_max_batch_base_layer_circuits(version: VmVersion) -> usize {
    match version {
        ...
        VmVersion::Vm1_5_0 | VmVersion::Vm_1_5_0_IncreaedBootloaderMemory => {
