...
use crate::{
    era_vm::tests::{
        ...
        utils::{read_expensive_contract, read_test_contract, sort_execution_state},
    },
...
fn test_predetermined_refunded_gas() {
    ...
    sort_execution_state(&mut current_state_without_predefined_refunds);
    ...
    sort_execution_state(&mut current_state_with_predefined_refunds);
    ...
    sort_execution_state(&mut current_state_with_changed_predefined_refunds);
