...
cat $ZKSYNC_HOME/contracts/ethereum/artifacts/cache/solpp-generated-contracts/state-transition/state-transition-interfaces/IZkSyncStateTransition.sol/IZkSyncStateTransition.json | jq '{ abi: .abi}' > IZkSyncStateTransition.json
