...
use zksync_types::{Address, ERC20_TRANSFER_TOPIC, H256, L1BatchNumber, StorageKey, StorageLog, Transaction};
        ...
        while !self.is_canceled() {
            ...
            match result {
                Ok(result) => {
                    ...
                    //todo: process in preimage_source
