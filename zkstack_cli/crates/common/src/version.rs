const GIT_VERSION: &str = zkstack_git_version_macro::build_git_revision!();
const GIT_BRANCH: &str = zkstack_git_version_macro::build_git_branch!();
const GIT_SUBMODULES: &[(&str, &str)] = zkstack_git_version_macro::build_git_submodules!();
const BUILD_TIMESTAMP: &str = zkstack_git_version_macro::build_timestamp!();
