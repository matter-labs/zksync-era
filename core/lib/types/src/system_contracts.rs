...
use zksync_system_constants::{
    ...
    EVENT_WRITER_ADDRESS, EVM_GAS_MANAGER_ADDRESS, INTEROP_ACCOUNT_ADDRESS,
    ...
    SECP256R1_VERIFY_PRECOMPILE_ADDRESS, PUBDATA_CHUNK_PUBLISHER_ADDRESS, SLOAD_CONTRACT_ADDRESS,
};
