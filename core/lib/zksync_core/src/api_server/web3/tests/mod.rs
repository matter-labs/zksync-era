...
impl HttpTest for TransactionCountTest {
    async fn test(
        ...
        for nonce in [0, 1] {
            let mut committed_tx = create_l2_transaction(U256::from(10), U256::from(200));
        ...
        let mut pending_tx = create_l2_transaction(U256::from(10), U256::from(200));
...
impl HttpTest for TransactionReceiptsTest {
    async fn test(
        ...
        let tx1 = create_l2_transaction(U256::from(10), U256::from(200));
        let tx2 = create_l2_transaction(U256::from(10), U256::from(200));
        let tx_results = vec![
