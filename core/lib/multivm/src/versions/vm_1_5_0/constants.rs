...
use crate::vm_1_5_0::{old_vm::utils::heap_page_from_base, MultiVmSubversion};
...
/// In the version `1.5.2` the maximal number of circuits per batch has been decreased from `34100` to `28000`.
