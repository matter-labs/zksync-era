...
pub async fn init_configs(
    ...
    match &init_args.validium_config {
        None | Some(ValidiumType::NoDA) | Some(ValidiumType::EigenDA) | Some(ValidiumType::EigenDAM1) => {
    ...
    match &init_args.validium_config {
        None | Some(ValidiumType::NoDA) | Some(ValidiumType::EigenDA) | Some(ValidiumType::EigenDAM1) => { /* Do nothing */ }
