...
use zksync_prover_interface::{
    api::{PollGeneratedProofsRequest, ProofGenerationData, SubmitProofRequest},
...
const SEND_PROOF_GENERATION_DATA_ENDPOINT: &str = "/submit_request_for_proofs";
const FETCH_PROOF_ENDPOINT: &str = "/poll_generated_proofs";
...
impl HttpClient {
    ...
    pub(crate) async fn fetch_proof(
        ...
        let response: Option<PollGeneratedProofsRequest> = self.send_http_request((), &endpoint).await?;
