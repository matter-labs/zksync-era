// src/worker.rs
//! One Tokio task per wallet (native ETH) using a global NonceManager.
    ...
    wallets
        ...
        .map(|(idx, wallet)| {
            ...
            tokio::spawn(async move {
                // ─── per-wallet signer with global NonceManager ───
                ...
                while running_cl.load(Ordering::Relaxed) {
                    ...
                    // build & send (nonce auto-filled by NonceManager)
