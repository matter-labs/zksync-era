...
use crate::{
    ...
    rounds::{
        node_aggregation::{
            NodeAggregation, NodeAggregationArtifacts, NodeAggregationWitnessGeneratorJob,
        },
...
#[async_trait]
impl JobProcessor for WitnessGenerator<NodeAggregation> {
    ...
    async fn save_result(
        ...
        <Self as ArtifactsManager>::save_to_database(
            &self.connection_pool,
            job_id,
            started_at,
            blob_urls,
