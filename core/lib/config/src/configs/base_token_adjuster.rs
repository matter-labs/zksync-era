...
const DEFAULT_L1_UPDATE_DEVIATION: u32 = 10;
...
pub struct BaseTokenAdjusterConfig {
    ...
    #[serde(default = "BaseTokenAdjusterConfig::default_l1_update_deviation")]
    pub l1_update_deviation: u32,
...
impl Default for BaseTokenAdjusterConfig {
    fn default() -> Self {
        Self {
            ...
            l1_update_deviation: Self::default_l1_update_deviation(),
...
impl BaseTokenAdjusterConfig {
    ...
    pub fn default_l1_update_deviation() -> u32 {
        DEFAULT_L1_UPDATE_DEVIATION
    }
