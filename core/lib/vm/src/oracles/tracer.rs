...
#[derive(Debug, Clone)]
pub struct NoopMemoryTracer;

impl<const N: usize, E: VmEncodingMode<N>> VmWitnessTracer<N, E> for NoopMemoryTracer {}

impl Tracer for NoopMemoryTracer {
...
impl ExecutionEndTracer for NoopMemoryTracer {
    fn should_stop_execution(&self) -> bool {
...
impl PendingRefundTracer for NoopMemoryTracer {}
...
pub struct OneTxTracer {
    ...
    pub operator_suggested_refund_gas: u32,
