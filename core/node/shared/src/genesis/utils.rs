...
use zksync_types::{
    ...
    AccountTreeId, L1BatchNumber, L2BlockNumber, L2ChainId, StorageKey, StorageLog, StorageLogKind,
    H256,
};
...
pub(super) fn get_deduped_log_queries(storage_logs: &[(H256, Vec<StorageLog>)]) -> Vec<LogQuery> {
