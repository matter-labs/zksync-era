...
fn open_l1_batch(number: u32, timestamp: u64, first_l2_block_number: u32) -> SyncAction {
    SyncAction::OpenBatch {
        params: L1BatchParams {
            ...
            fee_input: BatchFeeInput::pubdata_independent(
                U256::from(2),
                U256::from(3),
                U256::from(4),
            ),
...
async fn test_external_io_recovery(
    ...
    let new_tx = create_l2_transaction(U256::from(10), U256::from(100));
...
pub(super) async fn run_state_keeper_with_multiple_l1_batches(
    ...
    let first_tx = create_l2_transaction(U256::from(10), U256::from(100));
    ...
    let second_tx = create_l2_transaction(U256::from(10), U256::from(100));
